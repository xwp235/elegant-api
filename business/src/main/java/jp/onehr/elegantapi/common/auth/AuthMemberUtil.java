...
@Component
public class AuthMemberUtil extends AuthUtil {

    public SaSession getSession() {
        if (!isLogin()){
            return null;
        }
        return StpMemberUtil.getSession();
    }
    ...
    public String getClientId()  {
        ...
        return StpMemberUtil.getTokenValueByLoginId(userId,device);
    }
    ...
    public List<String> getLoggedInSessionIdList() {
        return StpMemberUtil.searchSessionId("", 0, -1, false);
    }
