...
import jp.onehr.elegantapi.common.limiter.strategy.DefaultKeyGenerateStrategy;
import jp.onehr.elegantapi.common.limiter.strategy.IKeyGenerateStrategy;
        ...
        for (var str : strategies) {
            keyGenerateStrategyList.stream()
                    ...
                    .ifPresent(currentGenerateKey -> {
                                if (!key.isEmpty()) {
                                    key.append(SymbolConstants.COLON);
                                }
