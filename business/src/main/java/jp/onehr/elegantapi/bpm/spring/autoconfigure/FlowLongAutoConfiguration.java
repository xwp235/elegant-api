...
import jp.onehr.elegantapi.bpm.engine.*;
import jp.onehr.elegantapi.bpm.engine.cache.FlowCache;
import jp.onehr.elegantapi.bpm.engine.core.FlowLongContext;
import jp.onehr.elegantapi.bpm.engine.core.FlowLongEngineImpl;
import jp.onehr.elegantapi.bpm.engine.dao.*;
import jp.onehr.elegantapi.bpm.engine.handler.ConditionNodeHandler;
import jp.onehr.elegantapi.bpm.engine.handler.CreateTaskHandler;
import jp.onehr.elegantapi.bpm.engine.handler.FlowJsonHandler;
import jp.onehr.elegantapi.bpm.engine.impl.*;
import jp.onehr.elegantapi.bpm.engine.listener.InstanceListener;
import jp.onehr.elegantapi.bpm.engine.scheduling.JobLock;
import jp.onehr.elegantapi.bpm.engine.scheduling.LocalLock;
import jp.onehr.elegantapi.bpm.spring.adaptive.FlowJacksonHandler;
import jp.onehr.elegantapi.bpm.spring.adaptive.SpelExpression;
import jp.onehr.elegantapi.bpm.spring.event.EventInstanceListener;
import jp.onehr.elegantapi.bpm.spring.event.EventTaskListener;
 ...
 */
@Configuration
@Import(FlowLongMybatisConfiguration.class)
